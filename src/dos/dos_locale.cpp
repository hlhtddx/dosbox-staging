...
static const std::string AnsiHighlight = "[color=green]";
...
std::string DOS_GenerateListKeyboardLayoutsMessage(const bool for_keyb_command)
{
	...
	const std::string header = MSG_GetRaw("DOSBOX_HELP_LIST_KEYBOARD_LAYOUTS_1");
...
static void load_keyboard_layout()
{
	...
	if (DOS_GetLoadedLayout().empty()) {
		uint16_t tried_code_page = DefaultCodePage;
