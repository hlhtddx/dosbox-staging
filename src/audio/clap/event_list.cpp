...
EventList::EventList()
{
	event_data.reserve(8192);    // bytes
	event_offsets.reserve(1024); // events

	sysex_data.reserve(MaxMidiSysExSize); // bytes
...
{
//	LOG_DEBUG("AddMidiEvent: msg.size: %d, sample_offset: %d",
//	          msg.size(),
//	          sample_offset);
